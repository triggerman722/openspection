...
<c:forEach var="weather" items="${searchresults}">
			<li class="media">
				...
				<h5 class="mt-0 mb-1"><a href="${contextPath}/${weather["username"]}/posts">${weather["username"]}</a></h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
				<p>
